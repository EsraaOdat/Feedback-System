<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddQuestion.aspx.cs" Inherits="Feedback_System.AddQuestion" %>
                    ...
                    <div class="card mt-2 mx-auto p-4 bg-light">
                        <div class="card-body bg-light">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="courseDropDownList" runat="server" CssClass="form-controll" required="required"></asp:DropDownList>
                            </div>
                            <div class="form-group">
                                <label for="question">Question *</label>
                                <asp:TextBox ID="questionTextBox" runat="server" CssClass="form-control" placeholder="Enter question" required="required"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <asp:Button ID="btnAddQuestion" runat="server" Text="Add Question" CssClass="btn btn-success btn-send btn-block" OnClick="btnAddQuestion_Click" />
                            </div>
                        </div>
                    </div>
                </div>
